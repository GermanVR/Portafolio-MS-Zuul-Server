package com.ms.project.portafolio.app.zuul.oauth;
 ...
 *         com.ms.project.portafolio.app.zuul.oauth Project Name: ms-zuul-server
 */
@RefreshScope
@Configuration
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/api/security/oauth/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/productos/listar", "/api/items/listar", "/api/usuarios/usuarios", "/api/usuarios/usuario")
				.permitAll()
